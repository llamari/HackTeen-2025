            ...
            <section className="section-login">
                <div id="login">
                    ...
                    <form id="login-form">
                        ...
                        <span id="wrong-login" aria-live="assertive" role="alert">E-mail ou senha inválidos!</span>
                    </form>
                    <button type="submit" aria-label="Entrar no sistema Inclusound!" className="doLogin" onClick={SignIn}>ENTRAR</button>
                </div>
                <div id="sign-up">
                    ...
                    <button type="submit" aria-label="Cadastrar-se no sistema Inclusound!" className="goToSignup" onClick={() => navigate('/signup')}>Cadastrar</button>
                </div>
            </section>
        </div>
    )
